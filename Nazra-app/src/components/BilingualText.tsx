    ...
    <div className={glass ? 'glass-panel p-5 sm:p-6' : ''}>
      {arabic && (
        <p
          dir="rtl"
          lang="ar"
          className="font-arabic text-2xl sm:text-3xl leading-[2.5] py-6 text-center text-ink-900 dark:text-parchment-100 mb-4"
        >
          {arabic}
        </p>
      )}
      ...
      {transliteration && (
        <p
          dir="ltr"
          className="text-center text-gold-600 dark:text-gold-300 italic text-sm sm:text-base mb-4"
        >
          {transliteration}
        </p>
      )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {translation_ur && (
          <div dir="rtl" lang="ur" className="md:border-r md:border-white/40 dark:md:border-white/15 md:pr-4">
            <p className="font-urdu text-lg sm:text-xl leading-[2] text-ink-800 dark:text-parchment-100">
              {translation_ur}
            </p>
          </div>
        )}
        {translation_en && (
          <div dir="ltr" lang="en">
            <p className="text-base sm:text-[17px] leading-relaxed text-ink-700 dark:text-parchment-200">
              {translation_en}
            </p>
          </div>
        )}
